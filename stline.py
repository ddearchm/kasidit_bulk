...
if st.button("📅 สร้างและดาวน์โหลด Excel + PDF"):
    ...
    with pd.ExcelWriter(excel_buffer, engine="openpyxl") as writer:
        ...
        TG_PRODUCTS = [
            ...
            "TPI-กาวยาแนวทีพีไอซูเปอร์พลัส M551","กาวยาแนวจระเข้บล็อกแก้ว","กาวยาแนวจระเข้แพลทินัม",
            "กาวยาแนวจระเข้เทอร์โบพลัส","กาวยาแนวจระเข้ พรีเมี่ยม พลัส ทอง","กาวยาแนวจระเข้พรีเมี่ยมพลัสเงิน",
            "กาวยาแนวเวเบอร์คัลเลอร์พาวเวอร์","กาวยาแนวชาละวัน","กาวปูและยาแนวกระเบื้องจระเข้อีพ็อกซี่พลัส"
        ]
